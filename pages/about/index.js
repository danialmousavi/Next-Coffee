...
import { faCheck} from "@fortawesome/free-solid-svg-icons"; // Import the icon you need
        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-lg-4 py-0 py-lg-5">
                    ...
                    <h5 className="mb-3"><FontAwesomeIcon icon={faCheck} className='mr-3 text-primary'/>Lorem ipsum dolor sit amet</h5>
                    <h5 className="mb-3"><FontAwesomeIcon icon={faCheck} className='mr-3 text-primary'/>Lorem ipsum dolor sit amet</h5>
                    <h5 className="mb-3"><FontAwesomeIcon icon={faCheck} className='mr-3 text-primary'/>Lorem ipsum dolor sit amet</h5>
